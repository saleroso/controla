...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/css/sb-admin-2.css">
...
<?php include('../common/menu_dinamico_ia.php');
            include('../common/submenu_ia.php')
            ?>
    <div class="container">
        <div class="row">
...
<?php include('../common/modals/logout.php');?>
</body>
</html>
